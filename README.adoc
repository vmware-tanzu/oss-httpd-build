...
== Phase 1: Gather Sources
 ...
 $ cd src/
 $ make -f Makefile.gather [BLD={type}] all
...
== Phase 2: Preconfigure Sources
 ...
 $ cd src/
 $ make -f Makefile.preconfig [BLD={type}] all
...
== Phase 3: Build Sources
 ...
 $ cd bld/
 $ make -f Makefile.build [BLD={type}] [TAG={-suffix}] all
...
== Phase 4: Test Source and Intermediate Installation
 ...
 $ cd bld/
 $ make -f Makefile.test [BLD={type}] [TAG={-suffix}] all
